...
class ProfileController extends ApiController
{
    ...
    */
    public function update(ApiProfileUpdateRequest $request) {
    	...
    	if ($user) {
            ...
            return response()->json(['code' => 200, 'status' => 'success', 'message' => 'Perfil de usuario actualizado con éxito.', 'data' => $user], 200);
        }
    ...
    */
    public function changePassword(ApiProfilePasswordUpdateRequest $request) {
        ...
        if ($user) {
            return response()->json(['code' => 200, 'status' => 'success', 'message' => 'Contraseña cambiada con éxito.'], 200);
        }
    ...
    */
    public function changeEmail(ApiProfileEmailUpdateRequest $request) {
        ...
        if ($user) {
            return response()->json(['code' => 200, 'status' => 'success', 'message' => 'El correo electrónico cambió con éxito.'], 200);
        }
