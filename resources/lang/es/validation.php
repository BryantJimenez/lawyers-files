...
return [
    ...
    */
    'attributes' => [
        ...
        'type_id'               => 'tipo',
        'logo'                  => 'logo',
        'header_background_color' => 'color de fondo de la barra superior',
        'header_text_color'     => 'color de texto de la barra superior',
        'menu_background_color' => 'color de fondo del menú',
        'menu_background_color_hover' => 'color de fondo del menú (activado)',
        'menu_icon_color'       => 'color de iconos del menú',
        'menu_text_color'       => 'color de texto del menú',
        'menu_border_color'     => 'color del borde del menú',
        'header_text'           => 'texto de la barra superior',
