						...
						<form action="{{ route('companies.store') }}" method="POST" class="form" id="formCompany">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									...
									<input class="form-control @error('social_reason') is-invalid @enderror" type="text" name="social_reason" required placeholder="Introduzca la razón social" value="{{ old('social_reason') }}">
								</div>
