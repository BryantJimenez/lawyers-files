					...
					<div class="col-12">
						...
						<form action="{{ route('companies.update', ['company' => $company->slug]) }}" method="POST" class="form" id="formCompany">
							...
							<div class="row">
								...
								<div class="form-group col-lg-6 col-md-6 col-12">
									<label class="col-form-label">Razón Social<b class="text-danger">*</b></label>
									<input class="form-control @error('social_reason') is-invalid @enderror" type="text" name="social_reason" required placeholder="Introduzca la razón social" value="{{ $company->social_reason }}">
								</div>

								<div class="form-group col-lg-6 col-md-6 col-12">
									<label class="col-form-label">RFC <b class="text-danger">*</b></label>
									<input class="form-control @error('rfc') is-invalid @enderror" type="text" name="rfc" required placeholder="Introduzca el RFC" value="{{ $company->rfc }}">
								</div>
								...
								<div class="form-group col-12">
									<div class="btn-group" role="group">
										<button type="submit" class="btn btn-primary mr-0" action="company">Actualizar</button>
