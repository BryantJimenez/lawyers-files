                        ...
                        <div class="form">
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('recovery.custom') }}" class="forgot-pass-link">Olvidé mi contraseña</a>
                                </div>
                            ...
                            <div class="d-sm-flex justify-content-center mt-3">
                                <div class="field-wrapper">
                                    <p class="text-center">No tienes cuenta? <a href="{{ route('register.custom') }}" class="text-primary m-l-5"><b>Registrate</b></a></p>
                                </div>
                            </div>
                        </div>
                    </form>
